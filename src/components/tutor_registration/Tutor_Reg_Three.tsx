    ...
    <div className="bg-[#FFF3E5] lg:px-[77px] md:px-[30px] lg:p-5 px-[15px] pb-6 w-[100vw] h-full overflow-hidden">
      ...
      <div>
        ...
        <div className="flex gap-2 mt-2">
          <Link href='/tutor_registration/step_two' className="bg-[#F77F00] text-white py-2 px-4 rounded-[30px]">Back</Link>
          <Link href='/tutor_registration/complete' className="bg-[#F77F00] text-white py-2 px-4 rounded-[30px]">Finish</Link>
        </div>
      </div>
    </div>
  );
