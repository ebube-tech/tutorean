    ...
    <div className="bg-[#FFF3E5] lg:px-[77px] md:px-[30px] lg:p-5 px-[15px] pb-6 w-[100%] h-full">
      ...
      <div>
        ...
        <div className="py-2 w-full overflow-hidden">
          ...
          <textarea className="bg-[#FFD580] text-black my-2 w-full p-2 rounded outline-none text-sm" placeholder="Introduce yourself in a few words. Share your passion of teaching, that makes your tutoring special" cols="50" rows="8"></textarea>
        </div>
        ...
        <div className="flex gap-2 mt-4">
          <Link href='/tutor_registration' className="bg-[#F77F00] text-white py-2 px-4 rounded-[30px]">Back</Link>
          <Link href='/tutor_registration/step_three' className="bg-[#F77F00] text-white py-2 px-4 rounded-[30px]">Continue</Link>
        </div>
      </div>
    </div>
  )
