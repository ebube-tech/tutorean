    ...
    <div className="bg-[#FFF3E5] lg:px-[77px] md:px-[30px] lg:p-5 px-[15px] pb-6 w-[100%] h-full">
      ...
      <div>
        ...
        <div className="flex gap-2 mt-4">
          <Link href='/tutor_reg' className="bg-[#F77F00] text-white py-2 px-4 rounded-[30px]">Back</Link>
          <Link href='/tutor_reg/step_three' className="bg-[#F77F00] text-white py-2 px-4 rounded-[30px]">Continue</Link>
        </div>
      </div>
    </div>
  </>
